...
if ( ! empty($_FILES))
{
	...
	if (in_array(fix_strtolower($extension), $ext))
	{
		...
		$_FILES['file']['name'] = fix_filename(\Nette\Utils\Strings::webalize($info['filename']).".".$extension,$transliteration,$convert_spaces, $replace_with);
		// LowerCase
		if ($lower_case)
		{
		...
		if (file_exists($targetPath.$_FILES['file']['name']))
		{
			...
			$_FILES['file']['name'] = \Nette\Utils\Strings::webalize($info['filename'])."_".$i.".".$extension;
		}
